 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'jNsfSNqiHo09sWFSGQ3FRh7e0GWM3cMH'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['port']          = '60306';          // MySQL port - leave blank for default port
